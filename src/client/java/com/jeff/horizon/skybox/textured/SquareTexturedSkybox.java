...
public class SquareTexturedSkybox extends TexturedSkybox {
    ...
    @Override
    public void renderSkybox(SkyRenderer skyRendererAccess, Matrix4fStack matrix4fStack, float tickDelta, Camera camera, DynamicTransformsBuilder transformsBuilder, GpuBufferSlice fogParameters, MultiBufferSource bufferSource) {
