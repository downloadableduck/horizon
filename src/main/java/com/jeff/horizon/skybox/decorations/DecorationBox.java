...
public class DecorationBox extends AbstractSkybox {
    ...
    public void render(SkyRenderer skyRendererAccessor, Matrix4fStack matrix4fStack, float tickDelta, Camera camera, GpuBufferSlice fogParameters, MultiBufferSource.BufferSource bufferSource) {
        ...
        if (this.sunEnabled) {
            this.renderSun((com.jeff.horizon.skybox.decorations.MultiBufferSource) bufferSource, poseStack);
        }
    ...
    private void renderSun(com.jeff.horizon.skybox.decorations.MultiBufferSource multiBufferSource, PoseStack poseStack) {
    ...
    private void renderMoon(int moonPhase, com.jeff.horizon.skybox.decorations.MultiBufferSource multiBufferSource, PoseStack poseStack) {
