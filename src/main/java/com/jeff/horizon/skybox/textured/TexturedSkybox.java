...
public abstract class TexturedSkybox extends AbstractSkybox implements TextureRegistrar {
    ...
    /**
     * Overrides and makes final here as there are options that should always be respected in DimensionType textured skybox.
     *
     ...
     */
    public abstract void renderSkybox(SkyRenderer skyRendererAccess, Matrix4fStack matrix4f, float tickDelta, Camera camera, DynamicTransformsBuilder transformsBuilder, GpuBufferSlice fogParameters, MultiBufferSource.BufferSource bufferSource);
}
