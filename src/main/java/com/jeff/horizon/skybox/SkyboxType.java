...
public class SkyboxType<T extends Skybox> {
    ...
    public static final ResourceKey<Registry<SkyboxType<? extends Skybox>>> SKYBOX_TYPE_REGISTRY_KEY = ResourceKey.createRegistryKey(Identifier.tryBuild(HorizonClient.MOD_ID, "skybox_type"));
