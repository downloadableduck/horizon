...
public class KeyMapping extends net.minecraft.client.KeyMapping {
    ...
    public static final KeyMapping.Category HORIZON_CATEGORY = KeyMapping.Category.register(ResourceLocation.fromNamespaceAndPath("nuit", "category"));

    public KeyMapping(String string, InputConstants.Type type, int i, String string2) {
        super(string, type, i, HORIZON_CATEGORY);
        this.name = string;
